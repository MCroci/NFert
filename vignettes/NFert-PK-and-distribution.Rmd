...
```{r prec-ag-setup, eval = requireNamespace("terra", quietly = TRUE)}
library(terra)
...
```{r prec-ag-calibration, eval = requireNamespace("terra", quietly = TRUE), fig.width = 6, fig.height = 5}
...
```{r prec-ag-holland, eval = requireNamespace("terra", quietly = TRUE), fig.width = 6, fig.height = 5}
...
```{r prec-ag-compare, eval = requireNamespace("terra", quietly = TRUE)}
...
```{r prec-ag-plan, eval = requireNamespace("terra", quietly = TRUE)}
...
```{r prec-ag-3pt, eval = requireNamespace("terra", quietly = TRUE)}
