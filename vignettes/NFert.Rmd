...
# Compare different organic sources
sources <- c("Cattle slurry", "Composted manure", "Pig slurry")
...
required_N <- calculate_N_fertilization(wheat_balance)
check_MAS("Grano tenero FF (granella)", round(required_N, 0))
```
...
NFert supports precision agriculture through NDVI-based nitrogen rate estimation. Here are two approaches:

## Method 1: Calibration Curve

```{r precision-ag-calibration, fig.width=10, fig.height=5}
...
```{r precision-ag-holland-schepers, fig.width=10, fig.height=6}
...
fields_data <- data.frame(
  ...
  crop = c("Grano tenero FF (granella)", "Shredded corn class 700", 
